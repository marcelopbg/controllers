...
| M button | Not mapped | Deck 1 Hotcue 1 (0x90/0x11) | Deck 1 Sync (0x90/0x12) | CH1 EQ high kill (0x90/0x13) | CH2 EQ high kill (0x90/0x14) | Deck 2 Sync (0x90/0x15) | Deck 2 Hotcue 1 (0x90/0x16) | Not mapped |
| S button | Not mapped | Deck 1 Hotcue 2 (0x90/0x09) | Deck 1 loop double (0x90/0x0A) | CH1 EQ mid kill (0x90/0x0B) | CH2 EQ mid kill (0x90/0x0C) | Deck 2 loop double (0x90/0x0D) | Deck 2 Hotcue 2 (0x90/0x0E) | Not mapped |
| R button | Not mapped | Not mapped | Deck 1 loop halve (0x90/0x02) | CH1 EQ low kill (0x90/0x03) | CH2 EQ low kill (0x90/0x04) | Deck 2 loop halve (0x90/0x05) | CH2 Keylock (0x90/0x06) | Not mapped |
...
| Slider | Master crossfader (0xE0) | Not mapped | CH1 rate (0xE2) | CH1 volume (0xE3) | CH2 volume (0xE4) | CH2 rate (0xE5) | Not mapped | Not mapped |
